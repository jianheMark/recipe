package jian.he.recipe.bootstrap;

import jian.he.recipe.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        if(pinchUomOptional.isEmpty()){throw new RuntimeException("Expected UOM not Found");}

        Optional<UnitOfMeasure> ounceUomOptional = unitOfMeasureRepository.findByDescription("Ounce");
        if(ounceUomOptional.isEmpty()){throw new RuntimeException("Expected UOM not Found");}
        ...
        if(italianCategoryOptional.isEmpty()){throw new RuntimeException("Expected Category not Found");}
        ...
        if(fastFoodCategoryOptional.isEmpty()){throw new RuntimeException("Expected Category not Found");}
...
//        guacNotes.setRecipe(guacRecipe);
        ...
        guacRecipe.getIngredients().add(new Ingredient("ripe avocados",new BigDecimal(1.2),  eachUom));
        guacRecipe.getIngredients().add(new Ingredient("Kosher salt",new BigDecimal(2),  teaspoonUom));
        guacRecipe.getIngredients().add(new Ingredient("fresh lime juice or lemon juice",new BigDecimal(1.3452),  tablespoonUom));
        guacRecipe.getIngredients().add(new Ingredient("minced red onion or thinly sliced green onio",new BigDecimal(1.3452),  tablespoonUom));
        guacRecipe.getIngredients().add(new Ingredient("serrano chiles, stems and seeds removed, minced",new BigDecimal(1.3452),  eachUom));
        guacRecipe.getIngredients().add(new Ingredient("Cilantro",new BigDecimal(2),  tablespoonUom));
        guacRecipe.getIngredients().add(new Ingredient("freshly grated black pepper",new BigDecimal(1.2),dashUom));
        guacRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chopped",new BigDecimal(0.5),  eachUom));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Salt",new BigDecimal(0.5),teaspoonUom));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("cherry tomatoes, halved",new BigDecimal(0.5),pintUom));
