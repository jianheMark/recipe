...
//        guacNotes.setRecipe(guacRecipe);
        ...
        guacRecipe.addIngredient(new Ingredient("ripe avocados",new BigDecimal(1.2),  eachUom));
        guacRecipe.addIngredient(new Ingredient("Kosher salt",new BigDecimal(2),  teaspoonUom));
        guacRecipe.addIngredient(new Ingredient("fresh lime juice or lemon juice",new BigDecimal(1.3452),  tablespoonUom));
        guacRecipe.addIngredient(new Ingredient("minced red onion or thinly sliced green onio",new BigDecimal(1.3452),  tablespoonUom));
        guacRecipe.addIngredient(new Ingredient("serrano chiles, stems and seeds removed, minced",new BigDecimal(1.3452),  eachUom));
        guacRecipe.addIngredient(new Ingredient("Cilantro",new BigDecimal(2),  tablespoonUom));
        guacRecipe.addIngredient(new Ingredient("freshly grated black pepper",new BigDecimal(1.2),dashUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("red onion, thinly sliced",new BigDecimal("0.28"),eachUom));
        ...
        tacosRecipe.setSource("SimpleRecipe");
